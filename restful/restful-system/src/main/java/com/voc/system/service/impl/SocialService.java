...
// */
//@Service
//public class SocialService extends BaseMongoService<UserBindPO, SocialDao> implements ISocialService {
//
//    @Override
//    public String bindUser(UserBindPO social) {
...
//        Optional<UserBindPO> one = this.findOne(query);
//        if (one.isPresent()) {
