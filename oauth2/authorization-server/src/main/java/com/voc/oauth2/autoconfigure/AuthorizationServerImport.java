package com.voc.oauth2.autoconfigure;

import com.voc.oauth2.autoconfigure.config.AuthorizationServerConfiguration;
import com.voc.oauth2.autoconfigure.config.DefaultSecurityConfiguration;
