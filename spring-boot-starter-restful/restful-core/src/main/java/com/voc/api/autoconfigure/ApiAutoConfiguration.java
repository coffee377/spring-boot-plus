...
import com.voc.api.response.ErrorHandlerController;
 ...
 */
@Configuration
@Import({JsonAutoConfiguration.class, RedisCacheAutoConfiguration.class,
        ErrorHandlerController.class, ResultAdvice.class, SpringUtil.class})
