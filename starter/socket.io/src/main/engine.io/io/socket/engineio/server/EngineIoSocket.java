...
import io.socket.engineio.ReadyState;
...
public final class EngineIoSocket extends Emitter {
    ...
    private TransportEmitter mTransport;
     ...
     */
    void init(TransportEmitter transport) {
     ...
     * @param transport The transport to upgrade to.
     */
    void upgrade(final TransportEmitter transport) {
        mUpgrading.set(true);
    ...
    private void setTransport(final TransportEmitter transport) {
